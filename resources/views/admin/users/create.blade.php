                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" method="POST" class="mx-2">
                            ...
                            <div class="row g-3 mb-3 align-items-center">
                                ...
                                <div class="col-7">
                                    <select class="form-select @error('role_id') is-invalid @enderror" name="role_id"
                                        required>
                                        <option selected disabled>Pilih Role untuk User</option>
                            ...
                            <div class="row g-3 mb-3 align-items-center">
                                <div class="col-3 col-md-2">
                                    <label for="jenisPengaduan_id" class="col form-label">Jenis Pengaduan</label>
                                </div>
                                <div class="col-7">
                                    <select class="form-select @error('jenisPengaduan_id') is-invalid @enderror" name="jenisPengaduan_id"
                                        required>
                                        <option selected disabled>Pilih Jenis Layanan untuk User</option>
                                        @foreach ($jenisPengaduan as $pengaduan)
                                            @if (old('jenisPengaduan_id') == $pengaduan->id)
                                                <option value="{{ $pengaduan->id }}" selected>{{ $pengaduan->nama }}</option>
                                            @else
                                                <option value="{{ $pengaduan->id }}">{{ $pengaduan->nama }}</option>
                                            @endif
                                        @endforeach
                                    </select>
