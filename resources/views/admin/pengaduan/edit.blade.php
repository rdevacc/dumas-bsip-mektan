...
@section('content')
    <main id="main" class="main">
        <form class="px-4 mx-auto col-md-9" method="POST" action="/admin/pengaduan/{{ $dataEdit->id }}"
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group col">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                        name="nama" value="{{ $dataEdit->nama ? $dataEdit->nama : old('nama') }}"
                        placeholder="Isikan nama lengkap anda" required autofocus>
                    @error('nama')
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group">
                    ...
                    <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                        name="nik" value="{{ $dataEdit->nik ? $dataEdit->nik : old('nik') }}"
                        placeholder="Isikan 16 digit NIK" required>
                    @error('nik')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group">
                    ...
                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                        name="email" value="{{ $dataEdit->email ? $dataEdit->email : old('email') }}"
                        placeholder="Isikan alamat e-mail anda" required>
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group">
                    ...
                    <textarea class="form-control @error('alamat') is-invalid @enderror" placeholder="Isi alamat lengkap anda"
                        id="alamat" name="alamat" style="height: 100px">{{ $dataEdit->alamat ? $dataEdit->alamat : old('alamat') }}</textarea>
                    @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col d-flex input-group">
                    ...
                    <select class="form-select form-select-md @error('pengaduan_id') is-invalid @enderror" id="pengaduan_id"
                        ...
                        @foreach ($jenisPengaduan as $pengaduan)
                            <option value="{{ $pengaduan->id }}" @selected(old('pengaduan_id', $dataEdit->pengaduan_id) == $pengaduan->id)>
                                {{ $pengaduan->nama }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group">
                    ...
                    <input type="jenis_lainnya" class="form-control @error('jenis_lainnya') is-invalid @enderror"
                        id="jenis_lainnya" name="jenis_lainnya"
                        value="{{ $dataEdit->jenis_lainnya ? $dataEdit->jenis_lainnya : old('jenis_lainnya') }}"
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group">
                    ...
                    <textarea class="form-control @error('isi_pengaduan') is-invalid @enderror" placeholder="Isi pengaduan anda"
                        id="isi_pengaduan" name="isi_pengaduan" style="height: 100px">{{ $dataEdit->isi_pengaduan ? $dataEdit->isi_pengaduan : old('isi_pengaduan') }}</textarea>
                    @error('isi_pengaduan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="row mb-3 d-flex">
                ...
                <div class="col d-flex input-group">
                    ...
                    <textarea class="form-control @error('saran_dan_masukkan') is-invalid @enderror" placeholder="Saran dan masukkan anda"
                        id="saran_dan_masukkan" name="saran_dan_masukkan" style="height: 100px">{{ $dataEdit->saran_dan_masukkan ? $dataEdit->saran_dan_masukkan : old('saran_dan_masukkan') }}</textarea>
                ...
                <div class="col d-flex input-group">
                    ...
                    <select class="form-select form-select-md @error('statusBukti_id') is-invalid @enderror"
                        ...
                        @foreach ($statusBukti as $status)
                            <option value="{{ $status->id }}" @selected(old('statusBukti_id', $dataEdit->statusBukti_id) == $status->id)>
                                {{ $status->nama }}</option>
                        @endforeach
                    </select>
            ...
            <input type="hidden" name="pj_id" id="pj_id" value="{{ $dataEdit->pj_id }}">
            <input type="hidden" name="oldImage" value="{{ $dataEdit->bukti_pengaduan }}">
            <div class="row mb-3 d-flex">
            ...
            <div class="d-flex justify-content-end">
                <div class="d-flex">
                    <a href="javascript: history.back()"
                        class="btn btn-warning text-white"><span>Back</span></a>
                </div>
