<div class="d-flex">
    <a class="btn btn-info" href="{{ route('showPengaduan', $model->id) }}" data-bs-toggle="tooltip" data-bs-placement="top"
        data-bs-custom-class="custom-tooltip" data-bs-title="Lihat Detail">
        <i class="bi bi-eye"></i>
    </a>
    <a class="btn btn-warning mx-1" href="{{ route('editPengaduan', $model->id) }}" data-bs-toggle="tooltip"
        data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="Edit Pengaduan">
        <i class="bi bi-pencil"></i>
    </a>
    <form action="{{ route('destroy-pengaduan', $model->id) }}" method="POST">
        @method('delete')
        @csrf
